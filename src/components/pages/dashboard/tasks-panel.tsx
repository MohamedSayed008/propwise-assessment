...
export function TasksPanel() {
  ...
  const handleToggle = useCallback(
    (id: string) => {
      ...
      setData({
        ...data,
        tasks: { ...data.tasks, items: updatedItems, completed: completedCount },
      });
  ...
  const progressPct = tasks.total > 0 ? (tasks.completed / tasks.total) * 100 : 0;
  ...
  return (
    <div className="rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-default)] p-6 shadow-xs">
      ...
      {/* Progress */}
      <div className="mt-3">
        <div className="flex items-center justify-between text-xs text-[var(--content-subtle)]">
          <span>
      ...
      {/* Task list */}
      <div className="mt-4 -mx-3 divide-y divide-[var(--border-muted)]">
